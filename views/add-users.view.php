...
//Unsetting the messages
    ...
    ?>  
        <div class="order-last text-center">
            <button class='btn btn-primary dropdown-toggle' data-toggle="collapse" href="#adduser" role="button" aria-expanded="false" aria-controls="share">
            Agregar usuario
            </button>
        </div>

        <div class="collapse order-last col-auto" id="adduser"> 
